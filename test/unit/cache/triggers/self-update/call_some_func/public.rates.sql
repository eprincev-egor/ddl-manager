create or replace function cache_totals_for_rates_on_rates()
...
create trigger cache_totals_for_rates_on_rates
after insert or update of price, quantity, vat_type, vat_value
on public.rates
for each row
execute procedure cache_totals_for_rates_on_rates();